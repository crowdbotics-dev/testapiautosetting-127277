...
## Project Structure
    ...
    ├── testapiautosetting_127277  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127277`
...
2. Clone this repo and `cd testapiautosetting_127277`
